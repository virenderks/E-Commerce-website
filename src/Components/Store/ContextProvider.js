  ...
  useEffect(() => {
    ...
    const onLoad = async () => {
      const res = await axios.get(
        `https://crudcrud.com/Dashboard/333a505152de46cba1498badabeec1c0/${userMailFinal}`
      );
  ...
  const addToCartHAndler = async (item) => {
    ...
    if (hasItem === true) {
      ...
      const res = await axios.put(
        `https://crudcrud.com/Dashboard/333a505152de46cba1498badabeec1c0/${userMailFinal}/${objId}`,
        objItem
      );
      try {
